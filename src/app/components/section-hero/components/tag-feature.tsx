...
const TagFeature = () => {
  return (
    <div className="inline-flex bg-purple-50 gap-3 rounded-2xl p-1 "> 
      ...
      <a href="/feature" className="flex gap-1 items-center text-[14px] text-brand font-semibold hover:opacity-50 transition-opacity border border-purple-100 rounded-2xl px-3">Confira o painel de equipe <FiArrowRight/> </a>
    </div>
  )
}
